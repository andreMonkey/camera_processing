...
#curl  -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{"overview": '"98:7B:F3:73:80:84"' , "type": '"Oximeter"'}' 'http://localhost:8080/api/devices'
